  ...
  return (
    <>
      <div className="relative mb-4">
        ...
        <div className="absolute left-1/2 transform -translate-x-1/2 -bottom-10 w-[96%] bg-[#2c2c2f] rounded-full flex items-center justify-between border-8 border-black" style={{ borderWidth: '8px', marginTop: '-12px', height: '80px' }}>
