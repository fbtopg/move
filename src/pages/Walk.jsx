...
const Walk = () => {
  ...
  return (
    <div className="h-screen flex flex-col bg-black text-white relative">
      ...
      <div 
        className="absolute bottom-0 left-0 right-0 h-52 flex items-center justify-center"
        style={{
          zIndex: 2,
      ...
      >
        <Button
          ...
          className="bg-white text-black hover:bg-gray-200 font-semibold py-4 px-4 rounded-lg text-lg w-full mx-2"
        >
          START
        </Button>
      </div>
