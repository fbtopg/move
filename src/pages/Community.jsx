...
const Community = () => {
  ...
  useEffect(() => {
    // Fetch user groups when session changes
  ...
  const renderContent = () => {
    if (!session || (session && userGroups.length === 0)) {
      return (
        ...
        >
          <div className="bg-white shadow-lg rounded-lg p-8 flex flex-col items-center w-full max-w-sm mx-auto mb-4"> {/* Changed mb-8 to mb-4 */}
            <img
