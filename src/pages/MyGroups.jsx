    ...
    <div className="min-h-screen bg-black text-white">
      <div className="max-w-md mx-auto p-4">
        ...
        <div className="grid grid-cols-1 gap-4">
          <GroupCard
            group={{ name: 'New group', members: 0, description: 'Create a new group', image: '' }}
