...
const GroupDetails = () => {
  ...
  return (
    <div className="full-screen flex flex-col bg-background text-foreground">
      ...
      <div className="p-8 pt-4 border-t pb-safe flex justify-end fixed bottom-0 left-0 right-0 bg-background">
        <Button
          className="bg-black text-white hover:bg-black/90 w-28 -mt-4"
          onClick={handleJoin}
        >
          Join now
        </Button>
