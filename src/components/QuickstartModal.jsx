...
const QuickstartModal = ({ isOpen, onClose }) => {
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="w-screen h-screen max-w-none p-0 m-0 border-t-0 flex flex-col justify-end">
        <DialogTitle className="text-2xl font-bold mb-4 text-center">Choose activity</DialogTitle>
