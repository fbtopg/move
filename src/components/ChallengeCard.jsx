...
const ChallengeCard = ({ type, date, active, progress }) => {
  ...
  return (
    <div className="w-full max-w-md mx-auto overflow-hidden h-[160px] flex cursor-pointer">
      <div 
        className="w-[160px] h-[160px] flex-shrink-0 bg-cover bg-center relative"
      ...
      >
        ...
        <div className="absolute bottom-2 right-2 text-right">
          <p className="text-xs text-white/80">{isWalk ? 'RANK' : 'PROGRESS'}</p>
