...
export const recommendedGroups = [
  { 
    ...
    members: 120, 
    image: 'https://hviyoqsvhpvddaafusuc.supabase.co/storage/v1/object/sign/images/group/groupbanner/Frame%20427319183.png?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1cmwiOiJpbWFnZXMvZ3JvdXAvZ3JvdXBiYW5uZXIvRnJhbWUgNDI3MzE5MTgzLnBuZyIsImlhdCI6MTcyODM1MDg3MiwiZXhwIjoxNzU5ODg2ODcyfQ.Z0O1doUyY0CCH1IZERBzi6Ty2sfA491fx8v54ICS58g&t=2024-10-08T01%3A27%3A53.465Z', 
    hasActivity: true, 
    lastActivity: '1h ago', 
  ...
  { 
    ...
    members: 150, 
    image: 'https://hviyoqsvhpvddaafusuc.supabase.co/storage/v1/object/sign/images/group/groupbanner/Frame%20427319185.png?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1cmwiOiJpbWFnZXMvZ3JvdXAvZ3JvdXBiYW5uZXIvRnJhbWUgNDI3MzE5MTg1LnBuZyIsImlhdCI6MTcyODM1MDg5OCwiZXhwIjoxNzU5ODg2ODk4fQ.lymuElwkXQVEeJ9xXzdauvAPudUprxpCLEK20PLl4g0&t=2024-10-08T01%3A28%3A19.778Z', 
    hasActivity: true, 
    lastActivity: '2h ago', 
    memberProfiles: [getRandomProfilePicture(), getRandomProfilePicture(), getRandomProfilePicture()], 
